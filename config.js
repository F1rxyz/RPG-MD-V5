...
/*============== INFO OWNER ==============*/
global.sig = 'https://instagram.com/Andiariskaard_'
global.syt = 'https://youtu.be/pO8AU'
...
global.nameown = 'Night.'


/*============== STAFF ==============*/
global.owner = [
  ['6285806459088', 'Night.', 'true']
...
/*============== WATERMARK ==============*/
global.wm = 'SevenNightラ | By Night.' //Main Watermark
global.wm2 = 'SevenNightラ'
global.wm3 = 'SevenNightラ | By Night.'
global.botdate = `⻝ 𝗗𝗮𝘁𝗲: ${week} ${date}\n⻝ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `⻝ 𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `SevenNightラ | ʙʏ ${global.nameown}`
global.author = 'Night' 
global.packname = 'SevenNightラ'
global.danied = '✘ 𝗘𝗥𝗢𝗥 𝟰𝟬𝟰'
global.ultahowner = '28-7-2023'
...
/*============== STICKER WM ==============*/
global.stickpack = 'SevenNightラ'
global.stickauth = `Nightmare.`
